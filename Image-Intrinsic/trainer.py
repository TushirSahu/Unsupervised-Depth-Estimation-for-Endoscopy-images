...
class Trainer:
    def __init__(self, options):
        ...
        # data
        datasets_dict = {"hamlyn": datasets.SCAREDRAWDataset}
        ...
        if self.num_pose_frames == 2:
            ...
            for f_i in self.opt.frame_ids[1:]:
                ...
                if f_i != "s":
                    ...
                    # pose
                    #concatenate wala warp module me
    ...
    def compute_reprojection_loss(self, pred, target): #Decomposing-Synthesis Loss
