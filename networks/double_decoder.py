...
class DepthDecoder(nn.Module):
    def __init__(self, num_ch_enc, scales=range(4), num_output_channels=1, use_skips=True, pretrained_x1='models/depth.pth', freeze_x1=True):
        ...
        # self.crf = NewCRF(input_dim=num_ch_enc[-1],embed_dim=num_ch_enc[-1],v_dim=num_ch_enc[-1],num_heads=8)
        # print(num_ch_enc[-1])
    ...
    def forward(self, input_features):
        ...
        for i in range(4, -1, -1):
            ...
            # x2 = self.convs_train[("upconv", i, 1)](x2)
# 
            ...
            if i in self.scales:                
                ...
                # self.outputs[("disp", i)] = torch.cat((self.outputs[("disp_1", i)], self.pretrained_outputs[("disp", i)] ), dim=1)
